...
export const siteData = {
  ...
  navigation: [
    ...
    { label: 'Portfolios', path: '/portfolio' },
    {
      ...
      path: '/services',
      dropdown: [
        { label: 'Website Design & Development', path: '/service-details' },
        { label: 'Mobile App Development', path: '/service-details' },
        { label: 'Digital Marketing', path: '/service-details' },
        { label: 'Product Development', path: '/service-details' },
      ],
    },
    {
      label: 'VA Services',
      path: '/va-services',
      dropdown: [
        { label: 'Email Management', path: '/va-services' },
        { label: 'Data Entry', path: '/va-services' },
        { label: 'Customer Support', path: '/va-services' },
        { label: 'Document Management', path: '/va-services' },
        { label: 'Research Work', path: '/va-services' },
      ],
    },
  ...
  footer: {
    ...
    serviceLinks: [
      ...
      { label: 'Mobile App Development', path: '/service-details' },
      { label: 'Digital Marketing', path: '/service-details' },
      { label: 'Product Development (OTS, Billing)', path: '/service-details' },
